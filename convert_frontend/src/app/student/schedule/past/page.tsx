        ...
        <div className="px-4 sm:px-6 py-5 space-y-4">
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {Object.entries(pastByDate).map(([dateKey, list]) => (
                        ...
                        <div key={session.sessionId} className="rounded-lg border border-gray-100 p-3 bg-gray-50">
                          ...
                          <Link
                            ...
                            className={`text-xs font-semibold inline-flex items-center gap-1 mt-2 ${
                              evaluated ? "text-blue-700 hover:text-blue-800" : "text-blue-700 hover:text-blue-800"
                            }`}
                          >
                            {evaluated ? "View Evaluation" : "Evaluate Session"}{" "}
