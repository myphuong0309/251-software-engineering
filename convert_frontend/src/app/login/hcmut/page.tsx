...
export default function HcmutLoginPage() {
  return (
      ...
      <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-md border border-gray-100">
        ...
        <form className="space-y-4">
          <div className="space-y-2">
            <label className="text-sm text-gray-700" htmlFor="hcmut-username">
              Username / Email
            </label>
            <input
              id="hcmut-username"
          ...
          <div className="space-y-2">
            <label className="text-sm text-gray-700" htmlFor="hcmut-password">
              Password
            </label>
            <input
              id="hcmut-password"
